...
(function (root, factory) {
  ...
  const zh = {
    ...
    'settings.macUpdateDescription': '自动检查新版本；发现后引导前往下载 DMG',
    'settings.developmentUpdateDescription': '开发模式不执行在线更新',
    'settings.unsupportedUpdateDescription': '当前平台不提供在线更新',
    ...
    'settings.updateMacHint': 'macOS 版不会自动替换应用；下载 DMG 后把 WorkMeow 拖进「应用程序」覆盖旧版即可。',
