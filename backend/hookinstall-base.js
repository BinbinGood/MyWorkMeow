...
function createInstaller(cfg) {
  ...
  // Claude Code's hook `shell` accepts 'bash' | 'powershell' and defaults to
  // bash everywhere except Windows-without-Git-Bash. We state it explicitly so
  // the value always matches the command syntax buildHookCommand() produced.
  function hookShell() {
